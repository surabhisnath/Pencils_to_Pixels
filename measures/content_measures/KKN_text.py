...
for modelname in modelnames:
    ...
    for creator in creators:
        ...
        df[col] = None
        for stim in ["G", "I", "R"]:
            texts = df[df["stimuli"] == stim]["gpt_caption"].tolist()
            df.loc[df["stimuli"] == stim, col] = find_mean_cosine_distances([embeddings[x] for x in texts])
